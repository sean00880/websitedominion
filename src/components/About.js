    ...
    <section id="about">
      ...
      <div className="fn_cs_about">
        <div className="left_part">
          <div className="img">
            <div className="img_in" data-bg-img="/img/about/mockup.png">
              <img src="/img/1x1.jpg" alt="" />
            </div>
          </div>
          <div className="bg_overlay">
            <div className="bg_color" />
            <div className="bg_image" data-bg-img="/img/about/logo.png" />
          </div>
        </div>
      ...
      <div className="container">
        ...
        <div className="fn_cs_mint">
          <div className="left_part">
            <h3 className="fn__maintitle" data-text="How to Purchase"  id="process">
              How to Purchase
            </h3>
            <div className="fn_cs_divider">
              <div className="divider">
            ...
            Follow our 4-step process to get started right away.  
            ...
            <a href="https://www.sitedominion.com/#pricing_section" style={{"textDecoration":"none"}}>
          ...
          <div className="right_part">
            ...
            <div className="fn_cs_steps">
              ...
              <li>
            <div className="item">
              <a href="https://www.sitedominion.com/" style={{"textDecoration":"none", "color":"black","textAlign":"center"}}>
              <div className="item_in">
              <h3 className="fn__gradient_title">01</h3>
                <p>Explore</p>
                <img src="/img/browse.png" style={{"width":"100px","height":"100px"}}/>
              </div>
              </a>
            </div>
          </li>
          <li>
            <div className="item">
            <a href="https://www.sitedominion.com/#pricing_section" style={{"textDecoration":"none","color":"black","textAlign":"center"}}>
              <div className="item_in">
                <h3 className="fn__gradient_title">02</h3>
                <p>Select a Package</p>
                <img src="/img/package.png" style={{"width":"100px","height":"100px"}}/>
              </div>
              </a>
            </div>
          </li>
          <li>
            ...
            <a href="https://www.sitedominion.com/#pricing_section" style={{"textDecoration":"none", "color":"black","textAlign":"center"}}>
              <div className="item_in">
                ...
                <img src="/img/icon-6.png" style={{"width":"100px","height":"100px"}}/>
              </div>
              </a>
            </div>
          </li>
          <li>
            <div className="item">
              <a href="https://www.sitedominion.com/#portfolio_section" style={{"textDecoration":"none", "color":"black","textAlign":"center"}}>
              <div className="item_in">
                <h3 className="fn__gradient_title">04</h3>
                <p>Website Delivered</p>
                <img src="/img/icon-5.png" style={{"width":"100px","height":"100px"}}/>
              </div>
              </a>
            </div>
          </li>
